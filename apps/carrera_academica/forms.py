...
class CarreraAcademicaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "fecha_vencimiento_original": forms.DateInput(
                attrs={"type": "date", "class": "form-control"}
            ),
            "fecha_vencimiento_actual": forms.DateInput(
                attrs={"type": "date", "class": "form-control"}
            ),
            "resolucion_designacion": forms.TextInput(attrs={"class": "form-control"}),
            "resolucion_puesta_en_funcion": forms.TextInput(
...
class JuntaEvaluadoraForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            "titular_frlp",
            "titular_externo1",
            "institucion_externo1",
            "titular_externo2",
            "institucion_externo2",
            "suplente_frlp",
            "suplente_externo",
...
class EvaluacionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "fecha_iniciada": forms.DateInput(
                attrs={"type": "date", "class": "form-control"}
            ),
            "anios_evaluados": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "[2022, 2023]"}
            ),
            "observaciones": forms.Textarea(attrs={"class": "form-control", "rows": 3}),
        }
