...
from .models import (Estudiante, AsignaturaParaEquivalencia,
                     SolicitudEquivalencia, DetalleSolicitud, DocumentoAdjunto)


@admin.register(Estudiante)
class EstudianteAdmin(admin.ModelAdmin):
    list_display = ['nombre_completo',
                    'dni_pasaporte', 'email_estudiante', 'carrera']
...
class SolicitudEquivalenciaAdmin(admin.ModelAdmin):
    list_display = ['id', 'estudiante',
                    'fecha_inicio', 'estado_general', 'progreso']
