...
class EstudianteUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        return reverse_lazy('equivalencias:estudiante_detail', kwargs={'pk': self.object.pk})
...
class SolicitudCreateView(LoginRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        return reverse_lazy('equivalencias:solicitud_detail', kwargs={'pk': self.object.pk})
